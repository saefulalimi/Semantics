...
function Chat() {
  ...
  return(
    <div>
      ...
      {!showChat ? (
                <div class="sm:border-2 px-4 lg:px-24 py-16 lg:max-w-xl sm:max-w-md w-1/2 text-center rounded-md">
                    <div class="">
                    ...
                    <div class="w-full md:w-1/2  flex flex-col items-center bg-white py-5 md:py-8 px-6">
